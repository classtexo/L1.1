 ...
 * obsahuje vazby na Issue (agreguje do sebe Issues) metoda getIssuesCount
 */
...
public class Issue {
	...
	public String toString() {
		String sOut = "(" + this.id + ") " + name + "[" + state + "/"
				+ severity + "]";
		return sOut;
	}
	...
	public enum StateVals { // Je to trida, tzn ze se jsmenuje StateVals ne
							// stateVals a ma byt separe soubor.
		CREATED, ACCEPTED, SOLVED, REOPEN, FIXED
	}
