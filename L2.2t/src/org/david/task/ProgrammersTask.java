...
/*
 * Ukol: Podtrida ProgrammersTask: dedi od TaskAbstract atributy isSolved Issues
 * - obsahuje vazby na Issue (agreguje do sebe Issues) ????? Jak implementovat
 * "agregaco" - jakym mechanismem <List> ? Udelat nekolik instanci???? metoda
 * getIssuesCount
 * 
...
public class ProgrammersTask extends TaskAbstract {
	...
	// kdyz vsechny issues splneny tak getIsSolved vratie true; Specialitka
	// Overridingu
